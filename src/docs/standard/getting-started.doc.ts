...
|--------|-------------|---------------|
| **🏦 Banking Products** | Account types, fees, limits, channels | [📖 View Docs](/api/docs/catalog) |
| **💰 Currencies** | Multi-currency support and exchange rates | [📖 View Docs](/api/docs/catalog) |
| **📊 Fees Management** | Transaction, initiation, and penalty fees | [📖 View Docs](/api/docs/catalog) |
...
- **Banking Products**: \`http://localhost:${port}/api/docs/catalog\`
...
\`\`\`http
GET /api/v1/catalogs?page=1&limit=10&sortBy=name&sortOrder=asc
\`\`\`

### **Filtering**
Apply filters using query parameters:
\`\`\`http
GET /api/v1/catalogs?filter[status]=active&search=savings
\`\`\`
...
4. **[🏦 Banking Products](/api/docs/catalog)** - Business domain deep dive
