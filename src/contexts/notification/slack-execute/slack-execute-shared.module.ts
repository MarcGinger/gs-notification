...
import { SlackExecutePolicyService } from './slack-execute-policy.service';
/**
 * Slack Shared Module
 *
 * Provides common infrastructure and services for all slack-execute domain modules.
 * This module is marked as @Global to avoid re-importing in every domain module.
 *
 * Shared Services:
 * - SlackExecutePolicyService: PII policy registration for the entire domain
 ...
 * - SLACK_EXECUTE_DI_TOKENS.AUTHORIZATION_SERVICE: Noop/Opa-AuthorizationService for development
 *
 * Shared Infrastructure:
...
@Module({
  ...
  providers: [
    ...
    SlackExecutePolicyService,

    // Domain-specific infrastructure token mappings
    {
      provide: SLACK_EXECUTE_DI_TOKENS.IO_REDIS,
      useExisting: IO_REDIS,
    },
    {
      provide: SLACK_EXECUTE_DI_TOKENS.DATA_SOURCE,
      useExisting: DATA_SOURCE,
    },
    {
      provide: SLACK_EXECUTE_DI_TOKENS.CACHE_SERVICE,
      useExisting: CACHE_SERVICE,
    },

    // Common infrastructure services
    {
      provide: SLACK_EXECUTE_DI_TOKENS.AUTHORIZATION_SERVICE,
    ...
    },
    {
      ...
      useFactory: (clock: Clock) =>
        new MetadataFactory(SlackExecuteServiceConstants.SERVICE_NAME, clock),
    },
    ...
    // Application-scoped logger using centralized constants
    {
      ...
      useFactory: (loggerFactory: ServiceLoggerFactory) => {
        return loggerFactory.getLogger({
          boundedContext: SlackExecuteServiceConstants.BOUNDED_CONTEXT,
  ...
  exports: [
    ...
    SlackExecutePolicyService,
    SLACK_EXECUTE_DI_TOKENS.AUTHORIZATION_SERVICE,
    SLACK_EXECUTE_DI_TOKENS.IO_REDIS,
    SLACK_EXECUTE_DI_TOKENS.DATA_SOURCE,
    SLACK_EXECUTE_DI_TOKENS.CACHE_SERVICE,
    MetadataFactory,
    RepositoryMetricsService,
    APP_LOGGER,
  ],
})
export class SlackExecuteSharedModule {}
