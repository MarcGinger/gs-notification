...
// Execute Projector Module
// Configures Execute Projector with shared projection infrastructure
...
import { ExecuteProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [ExecuteProjectorHealthController],
  exports: [ExecuteProjector],
})
export class ExecuteProjectorModule {}
