...
/**
 * Token for injecting IExecuteQuery port implementation
 */
export const EXECUTE_QUERY_TOKEN = 'IExecuteQuery' as const;

/**
 * Execute Query Port - Interface Segregation Principle Implementation
 *
 ...
 *
 * @domain Notification Context - Execute Query Port
 * @layer Application Ports
 * @pattern Interface Segregation Principle
 */
export interface IExecuteQuery {
  /**
   * Find a single Execute by its unique identifier (for CQRS query operations)
   ...
   * @returns A promise resolving to a Result containing the Execute or null if not found
   */
  findById(
    actor: ActorContext,
    id: string,
