...
/**
 * notification slack-execute application/service Documentation
 * This module handles the Swagger documentation for notifications
 *
 */
export class SlackExecuteDocumentation {
...
### application: slack-execute
  ...
  | Modules |
  |---------------|
  | [***execute  →***](/api/docs/notification/slack-execute/execute) |
  | [***template  →***](/api/docs/notification/slack-execute/template) |
  | [***channel  →***](/api/docs/notification/slack-execute/channel) |
  | [***workspace  →***](/api/docs/notification/slack-execute/workspace) |
        `,
      )
      .setVersion('1.0.0')
      .addTag(
        'SlackExecute',
        `Configuration for notification slack-execute application/service`,
      );
    ...
    SwaggerModule.setup('api/docs/notification/slack-execute', app, document);
  }
  ...
  static setupAll(
    ...
    SlackExecuteDocumentation.setup(app, port);

    // Setup sub-module documentation

    // Return all endpoint URLs
    return {
      notification: SlackExecuteDocumentation.getEndpoint(port),
    };
  }

  static getEndpoint(port: string | number): string {
    return `${SwaggerConfigUtil.getServerUrl(port)}/api/docs/notification/slack-execute`;
  }
}
