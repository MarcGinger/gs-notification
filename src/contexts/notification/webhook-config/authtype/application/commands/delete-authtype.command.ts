...
/**
 * Enhanced Delete Authtype Command with security context and metadata
 */
export class DeleteAuthtypeCommand extends BaseCommand {
  constructor(
    user: IUserToken,
  ...
  static create(
    ...
    return new DeleteAuthtypeCommand(user, id, correlationId, securityContext);
  }
}
