...
// Authtype Projector Module
// Configures Authtype Projector with shared projection infrastructure
...
import { AuthtypeProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [AuthtypeProjectorHealthController],
  exports: [AuthtypeProjector],
})
export class AuthtypeProjectorModule {}
