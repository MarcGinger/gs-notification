...
// SecureTest Projector Module
// Configures SecureTest Projector with shared projection infrastructure
...
import { SecureTestProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [SecureTestProjectorHealthController],
  exports: [SecureTestProjector],
})
export class SecureTestProjectorModule {}
