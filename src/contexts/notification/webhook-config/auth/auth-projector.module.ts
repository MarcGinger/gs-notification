...
// Auth Projector Module
// Configures Auth Projector with shared projection infrastructure
...
import { AuthProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [AuthProjectorHealthController],
  exports: [AuthProjector],
})
export class AuthProjectorModule {}
