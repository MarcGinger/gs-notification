...
/**
 * BackoffJitterPct Integer Value Object
 ...
 */
export const ConfigBackoffJitterPct = createIntegerVO({
  name: 'BackoffJitterPct',

  errors: createIntegerVOErrors(
    ConfigErrors.INVALID_BACKOFF_JITTER_PCT,
    'BackoffJitterPct',
  ),
});

/** Public instance type for BackoffJitterPct */
export type ConfigBackoffJitterPct = IntegerVOInstance;

// Convenience creators
export const createConfigBackoffJitterPct = (v: number) =>
  ConfigBackoffJitterPct.create(v);
export const configBackoffJitterPctFrom = (v: unknown) =>
  ConfigBackoffJitterPct.from(v);
