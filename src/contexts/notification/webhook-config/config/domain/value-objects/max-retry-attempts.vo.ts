 ...
 */
export const ConfigMaxRetryAttempts = createIntegerVO({
  name: 'MaxRetryAttempts',
  required: true,

  errors: createIntegerVOErrors(
    ConfigErrors.INVALID_MAX_RETRY_ATTEMPTS,
    'MaxRetryAttempts',
  ),
});

/** Public instance type for MaxRetryAttempts */
export type ConfigMaxRetryAttempts = IntegerVOInstance;

// Convenience creators
export const createConfigMaxRetryAttempts = (v: number) =>
  ConfigMaxRetryAttempts.create(v);
export const configMaxRetryAttemptsFrom = (v: unknown) =>
  ConfigMaxRetryAttempts.from(v);
