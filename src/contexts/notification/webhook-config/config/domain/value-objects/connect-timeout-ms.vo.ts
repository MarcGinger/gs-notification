 ...
 */
export const ConfigConnectTimeoutMs = createIntegerVO({
  name: 'ConnectTimeoutMs',

  errors: createIntegerVOErrors(
    ConfigErrors.INVALID_CONNECT_TIMEOUT_MS,
    'ConnectTimeoutMs',
  ),
});

/** Public instance type for ConnectTimeoutMs */
export type ConfigConnectTimeoutMs = IntegerVOInstance;

// Convenience creators
export const createConfigConnectTimeoutMs = (v: number) =>
  ConfigConnectTimeoutMs.create(v);
export const configConnectTimeoutMsFrom = (v: unknown) =>
  ConfigConnectTimeoutMs.from(v);
