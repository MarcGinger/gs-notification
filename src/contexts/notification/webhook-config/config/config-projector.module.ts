...
// Config Projector Module
// Configures Config Projector with shared projection infrastructure
...
import { ConfigProjector } from './infrastructure/projectors';
import { ConfigProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [ConfigProjectorHealthController],
  exports: [ConfigProjector],
})
export class ConfigProjectorModule {}
