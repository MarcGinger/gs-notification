...
/**
 * ConnectTimeoutMs Integer Value Object
 ...
 */
export const WebhookConnectTimeoutMs = createIntegerVO({
  name: 'ConnectTimeoutMs',

  errors: createIntegerVOErrors(
    WebhookErrors.INVALID_CONNECT_TIMEOUT_MS,
    'ConnectTimeoutMs',
  ),
});

/** Public instance type for ConnectTimeoutMs */
export type WebhookConnectTimeoutMs = IntegerVOInstance;

// Convenience creators
export const createWebhookConnectTimeoutMs = (v: number) =>
  WebhookConnectTimeoutMs.create(v);
export const webhookConnectTimeoutMsFrom = (v: unknown) =>
  WebhookConnectTimeoutMs.from(v);
