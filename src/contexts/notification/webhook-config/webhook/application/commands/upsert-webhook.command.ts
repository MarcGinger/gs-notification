...
import { UpsertWebhookProps } from '../../domain/props';

/**
 * Enhanced Upsert Webhook Command with security context and metadata
 */
export class UpsertWebhookCommand extends BaseCommand {
  constructor(
    user: IUserToken,
    public readonly id: string,
    public readonly props: UpsertWebhookProps,
  ...
  static create(
    ...
    return new UpsertWebhookCommand(
      user,
      id,
      props,
      correlationId,
