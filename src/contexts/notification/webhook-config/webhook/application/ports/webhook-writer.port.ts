...
/**
 * Token for injecting IWebhookWriter port implementation
 */
export const WEBHOOK_WRITER_TOKEN = 'IWebhookWriter' as const;

/**
 * Webhook Writer Port - Interface Segregation Principle Implementation
 *
 ...
 *
 * @domain Notification Context - Webhook Writer Port
 * @layer Application Ports
 * @pattern Interface Segregation Principle
 */
export interface IWebhookWriter {
  /**
   * Save a Webhook aggregate (create or update)
