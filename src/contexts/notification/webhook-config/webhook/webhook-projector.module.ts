...
// Webhook Projector Module
// Configures Webhook Projector with shared projection infrastructure
...
import { WebhookProjector } from './infrastructure/projectors';
import { WebhookProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [WebhookProjectorHealthController],
  exports: [WebhookProjector],
})
export class WebhookProjectorModule {}
