...
// TestSecurity Projector Module
// Configures TestSecurity Projector with shared projection infrastructure
...
import { TestSecurityProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  providers: [
    // Map webhook-config domain tokens to infrastructure tokens
    {
      provide: WEBHOOK_CONFIG_DI_TOKENS.IO_REDIS, // 'WebhookConfigRedisClient'
      useExisting: IO_REDIS, // 'IORedis'
    },
    {
      provide: WEBHOOK_CONFIG_DI_TOKENS.DATA_SOURCE, // 'WebhookConfigDataSource'
      useExisting: DATA_SOURCE, // 'DATA_SOURCE'
    },
    {
      provide: WEBHOOK_CONFIG_DI_TOKENS.CHECKPOINT_STORE, // 'WebhookConfigCheckpointStore'
    ...
    {
      provide: WEBHOOK_CONFIG_DI_TOKENS.CACHE_SERVICE, // 'WebhookConfigCacheService'
      useExisting: CACHE_SERVICE, // 'CACHE_SERVICE'
    },
    {
      provide: WEBHOOK_CONFIG_DI_TOKENS.CATCHUP_RUNNER, // 'WebhookConfigCatchupRunner'
      inject: [
        EventStoreService,
        WEBHOOK_CONFIG_DI_TOKENS.CHECKPOINT_STORE,
        APP_LOGGER,
      ],
      useFactory: (
    ...
    TestSecurityProjector,
  ],
  controllers: [TestSecurityProjectorHealthController],
  exports: [TestSecurityProjector],
})
export class TestSecurityProjectorModule {}
