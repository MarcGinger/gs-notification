...
/**
 * TestSecurity Field Validator Utility
 *
 * Centralized utility for parsing and validating TestSecurity aggregate data from EventStore events.
 * Provides consistent field validation patterns that can be reused across repositories
 * and projectors for TestSecurity domain operations.
 *
 * @domain Notification Context - TestSecurity Field Validation Utility
 * @layer Infrastructure
 * @pattern Utility Pattern + Field Validation
 */
export class TestSecurityFieldValidatorUtil {
  /**
   ...
   */
  static createTestSecurityProjectorDataFromEventData(
