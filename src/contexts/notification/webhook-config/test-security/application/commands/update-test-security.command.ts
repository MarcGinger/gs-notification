...
/**
 * Enhanced Update TestSecurity Command with security context and metadata
 */
export class UpdateTestSecurityCommand extends BaseCommand {
  constructor(
    user: IUserToken,
    public readonly id: string,
    public readonly props: UpdateTestSecurityProps,
  ...
  static create(
    ...
    return new UpdateTestSecurityCommand(
      user,
      id,
      props,
      correlationId,
