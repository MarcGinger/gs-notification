...
/**
 * Enhanced Delete TestSecurity Command with security context and metadata
 */
export class DeleteTestSecurityCommand extends BaseCommand {
  constructor(
    user: IUserToken,
  ...
  static create(
    ...
    return new DeleteTestSecurityCommand(
      user,
      id,
      correlationId,
      securityContext,
