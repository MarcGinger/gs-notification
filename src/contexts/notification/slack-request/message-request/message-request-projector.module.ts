...
// MessageRequest Projector Module
// Configures MessageRequest Projector with shared projection infrastructure
...
@Module({
  ...
  providers: [
    ...
    MessageRequestProjector,
  ],
  controllers: [MessageRequestProjectorHealthController],
  exports: [MessageRequestProjector],
})
export class MessageRequestProjectorModule {}
