 ...
 * Handles workspace reference data lookups for FK validation in the MessageRequest context using Redis projections
 ...
 *
 * @domain Notification Context - MessageRequest Workspace Reader Repository (Redis)
