 ...
 */
export const MessageRequestId = createUuidVO({
  name: 'Id',
  required: true,
  version: 4,
  ...
  errors: createUuidVOErrors(MessageRequestErrors.INVALID_ID, 'Id'),
});

/** Public instance type for Id */
export type MessageRequestId = UuidVOInstance;

// Convenience creators
export const createMessageRequestId = (v: string) => MessageRequestId.create(v);
export const messageRequestIdFrom = (v: unknown) => MessageRequestId.from(v);
