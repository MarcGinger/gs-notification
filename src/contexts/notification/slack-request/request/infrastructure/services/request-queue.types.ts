...
/**
 * BullMQ Job Schema and Queue Configuration for Request Processing
 *
...
/**
 * SendRequestJob - Minimal BullMQ job payload
 *
 ...
 */
export interface SendRequestJob {
  /** UUID of the Request */
  requestCode: string;
...
export const REQUEST_QUEUE = {
  ...
  JOB_NAME: 'send-request',
} as const;

/**
 * Request-specific Job Options
 *
 * Type alias for BullMQ JobsOptions used in Request processing.
 * Uses shared defaults from DEFAULT_JOB_OPTIONS.
 */
export type SendRequestJobOptions = JobsOptions;

/**
 * Default job options following refinement.md recommendations
 * Uses shared defaults with Request-specific configuration.
 */
export const DEFAULT_SEND_REQUEST_JOB_OPTIONS: SendRequestJobOptions = {
  ...DEFAULT_JOB_OPTIONS,
  // Request-specific overrides can be added here if needed
} as const;
