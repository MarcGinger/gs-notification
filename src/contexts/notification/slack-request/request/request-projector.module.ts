...
// Request Projector Module
// Configures Request Projector with shared projection infrastructure
...
import { RequestProjectorHealthController } from './interface/http/controllers';
...
@Module({
  imports: [
    ...
    // Import RequestModule to access RequestQueueService
    RequestModule,
  ],
  providers: [
  ...
  controllers: [RequestProjectorHealthController],
  exports: [RequestProjector],
})
export class RequestProjectorModule {}
