...
import { ISentRequestUseCase } from './contracts';
...
@Injectable()
export class SentRequestUseCase implements ISentRequestUseCase {
  ...
  async execute(params: {
    ...
    const operation = 'record_request_sent';
    ...
    try {
      ...
      const eventMetadata: EventMetadata = {
        ...
        actor: {
          ...actor,
          sessionId: 'record-request-sent-use-case',
        },
