...
// FullMessage Projector Module
// Configures FullMessage Projector with shared projection infrastructure
...
import { FullMessageProjectorHealthController } from './interface/http/controllers';
...
@Module({
  imports: [
    ...
    // Import FullMessageModule to access FullMessageQueueService
    FullMessageModule,
  ],
  providers: [
    ...
    },
    {
      ...
      inject: [
        EventStoreService,
        SLACK_REQUEST_DI_TOKENS.CHECKPOINT_STORE,
        APP_LOGGER,
      ],
      useFactory: (
    ...
    FullMessageProjector,
  ],
  controllers: [FullMessageProjectorHealthController],
  exports: [FullMessageProjector],
})
export class FullMessageProjectorModule {}
