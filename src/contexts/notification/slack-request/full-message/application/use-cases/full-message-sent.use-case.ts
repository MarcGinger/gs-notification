...
import { ISentFullMessageUseCase } from './contracts';
...
@Injectable()
export class SentFullMessageUseCase implements ISentFullMessageUseCase {
  ...
  constructor(
    ...
    this.loggingConfig = {
      ...
      component: 'SentFullMessageUseCase',
  ...
  async execute(params: {
    ...
    const operation = 'record_full_message_sent';
    ...
    try {
      ...
      const eventMetadata: EventMetadata = {
        ...
        actor: {
          ...actor,
          sessionId: 'record-full-message-sent-use-case',
        },
