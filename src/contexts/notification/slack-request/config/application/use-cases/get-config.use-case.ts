...
export class GetConfigUseCase implements IGetConfigUseCase {
  ...
  async execute(params: {
    ...
    const safeLogContext = UseCaseLoggingUtil.createLogContext(
      ...
      {
        configWorkspaceCode: rawProps.workspaceCode,
    ...
    const authResult = await this.authorizationService.canReadResource(
      params.user.sub,
      params.workspaceCode, // Using workspaceCode as config identifier
      correlationId,
      {
    ...
    if (!authResult.value) {
      const authError = {
        ...
        context: {
          ...
          configWorkspaceCode: params.workspaceCode,
          operation: 'read',
        },
      };
      UseCaseLoggingUtil.logOperationError(
    ...
    if (
      ...
      const validationError = {
        ...
        title: 'Invalid config workspaceCode',
