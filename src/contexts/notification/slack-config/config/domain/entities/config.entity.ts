 ...
 * - Identity: WorkspaceCode as unique identifier
...
> {
  ...
  private constructor(props: ConfigDomainState) {
    super(props, props.workspaceCode);
  }
  ...
  public static fromSnapshot(
    ...
    const workspaceCodeResult = ConfigWorkspaceCode.from(
  ...
  private static validate(props: ConfigDomainState): Result<void, DomainError> {
    ...
    if (!props.workspaceCode) {
      return err(ConfigErrors.INVALID_WORKSPACE_CODE_DATA);
    }
    ...
    if (!props.loggingEnabled) {
      return err(ConfigErrors.INVALID_LOGGING_ENABLED_DATA);
    }
  ...
  public get workspaceCode(): ConfigWorkspaceCode {
  ...
  public get loggingEnabled(): ConfigLoggingEnabled {
    return this.props.loggingEnabled;
  }

  public get auditChannelId(): ConfigAuditChannelId | undefined {
  ...
  public sameAs(other: ConfigEntity): boolean {
    return this.props.workspaceCode.equals(other.props.workspaceCode);
  }
