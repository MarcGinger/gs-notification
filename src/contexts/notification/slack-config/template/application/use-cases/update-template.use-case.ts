...
import { updateTemplateAggregateFromSnapshot } from '../../domain/factories';
...
export class UpdateTemplateUseCase implements IUpdateTemplateUseCase {
  ...
  constructor(
    ...
    this.loggingConfig = {
      ...
      component: 'UpdateTemplateUseCase',
      domain: 'slack-config',
      entityType: 'template',
    };
  ...
  async execute(params: {
    ...
    const operation = 'update_template';
    ...
    >({
      ...
      component: 'UpdateTemplateUseCase',
      operation: 'update_template',
      source: 'slack-config.application.update-template',
      command,
      logger: this.logger,
      clock: this.clock,
      repo: {
      ...
      loadExisting: async (actor, cmd) => {
        const codeR = TemplateCode.from(cmd.code);
