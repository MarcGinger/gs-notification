 ...
 */
export class ListTemplateFilterRequest extends BaseSortableListFilterRequest {
  ...
  /**
   * Override sortBy with template-specific schema for better Swagger documentation
   */
  @ApiPropertyOptional({
    type: 'object',
