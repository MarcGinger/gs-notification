 ...
 *
 * Represents the core Template entity in the notification domain.
 ...
 *
 * @domain Notification Context - Template Entity
 ...
 * Template Entity
 *
 * Core domain entity representing a template in the notification.
...
> {
  ...
  public toSnapshot(): TemplateSnapshotProps {
    return {
      ...
      contentBlocks: this.props.contentBlocks.value,
      variables: this.props.variables?.value,
