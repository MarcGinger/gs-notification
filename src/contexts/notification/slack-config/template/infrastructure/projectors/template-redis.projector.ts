...
/**
 * Template projection parameters for unified processing
 */
interface TemplateProjectionParams extends UnifiedProjectionParams {
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  private static readonly UNIFIED_CONFIG: UnifiedProjectionConfig = {
    ...
    getRedisEntityKey: (tenant: string, id: string) =>
      TemplateProjectionKeys.getRedisTemplateKey(tenant, id),
    getRedisIndexKey: (tenant: string) =>
      TemplateProjectionKeys.getRedisTemplateIndexKey(tenant),
    getEntityId: (params) => (params as TemplateProjectionParams).code,
  };
  ...
  constructor(
    ...
    this.projectorUtils = new UnifiedProjectorUtils(
      TemplateProjector.UNIFIED_CONFIG,
      this.redis,
    ...
    Log.info(
      this.logger,
      'TemplateProjector initialized with production-ready utilities',
      {
        method: 'constructor',
  ...
  onModuleInit(): void {
    Log.info(
      this.logger,
      'Starting Template Projector with production-ready features',
      {
        method: 'onModuleInit',
        subscriptionGroup: this.subscriptionGroup,
      },
  ...
  /**
   * Extract template parameters with enhanced error context
   *
  ...
  private extractTemplateParams(
    ...
    try {
      ...
      // Use existing TemplateFieldValidatorUtil for validation
      const templateData =
