 ...
 * - Template Hash: `template:projection:{tenant}:code` - stores all template fields
 * - Tenant Index: `template:index:by_tenant:{tenant}` - sorted set by updated timestamp
 *
 * Key Features:
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  private generateClusterSafeKeys(params: TemplateProjectionParams): {
    ...
    const entityKey = 'template:{' + params.tenant + '}:' + params.code;
    const indexKey = 'template:index:{' + params.tenant + '}';
