...
export class TemplateWriterRepository implements ITemplateWriter {
  ...
  async save(
    ...
    try {
      ...
      const projection: TemplateProjection = {
        ...
        workspaceId: template.entity.workspaceId.toArray(),
        name: template.entity.name.value,
        description: template.entity.description?.value,
        contentBlocks: template.entity.contentBlocks.value,
        variables: template.entity.variables?.value,
      ...
      templateStore.set(actor.tenantId, template.id.value, projection);
  ...
  async delete(
    ...
    try {
      ...
      if (!templateStore.has(actor.tenantId || 'default-tenant', code.value)) {
      ...
      templateStore.delete(actor.tenantId || 'default-tenant', code.value);
