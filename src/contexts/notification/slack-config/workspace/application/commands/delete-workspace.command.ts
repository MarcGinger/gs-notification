...
/**
 * Enhanced Delete Workspace Command with security context and metadata
 */
export class DeleteWorkspaceCommand extends BaseCommand {
  constructor(
    user: IUserToken,
  ...
  static create(
    ...
    return new DeleteWorkspaceCommand(user, id, correlationId, securityContext);
  }
}
