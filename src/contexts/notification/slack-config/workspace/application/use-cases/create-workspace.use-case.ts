...
import type { WorkspaceAggregate } from '../../domain/aggregates';
import { createWorkspaceAggregateFromProps } from '../../domain/factories';
...
import { ICreateWorkspaceUseCase } from './contracts';
...
export class CreateWorkspaceUseCase implements ICreateWorkspaceUseCase {
  ...
  constructor(
    ...
    this.loggingConfig = {
      ...
      component: 'CreateWorkspaceUseCase',
      domain: 'slack-config',
  ...
  async execute(params: {
    ...
    const operation = 'create_workspace';
    ...
    const safeLogContext = UseCaseLoggingUtil.createLogContext(
      ...
      {
        workspaceCode: command.props.id,
    ...
    >({
      ...
      component: 'CreateWorkspaceUseCase',
      operation: 'create_workspace',
      source: 'slack-config.application.create-workspace',
      command,
      logger: this.logger,
      clock: this.clock,
      ...
      repo: {
        save: async (
          ...
          // TODO: PII protection should be implemented in WorkspaceWriter implementation
          // at the persistence boundary, not here in the application layer.
          // The WorkspaceWriter adapter should:
