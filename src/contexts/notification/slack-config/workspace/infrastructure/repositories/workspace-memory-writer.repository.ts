...
export class WorkspaceWriterRepository implements IWorkspaceWriter {
  ...
  async save(
    ...
    try {
      ...
      const projection: WorkspaceProjection = {
        ...
        code: workspace.entity.code.value,
      ...
      workspaceStore.set(actor.tenant, workspace.id.value, projection);
  ...
  async delete(
    ...
    try {
      ...
      if (!workspaceStore.has(actor.tenant || 'default-tenant', code.value)) {
      ...
      workspaceStore.delete(actor.tenant || 'default-tenant', code.value);
