...
/**
 * Workspace projection parameters for unified processing
 */
interface WorkspaceProjectionParams extends UnifiedProjectionParams {
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  private static readonly UNIFIED_CONFIG: UnifiedProjectionConfig = {
    ...
    getRedisEntityKey: (tenant: string, id: string) =>
      WorkspaceProjectionKeys.getRedisWorkspaceKey(tenant, id),
    getRedisIndexKey: (tenant: string) =>
      WorkspaceProjectionKeys.getRedisWorkspaceIndexKey(tenant),
    getEntityId: (params) => (params as WorkspaceProjectionParams).code,
  };
  ...
  constructor(
    ...
    this.projectorUtils = new UnifiedProjectorUtils(
      WorkspaceProjector.UNIFIED_CONFIG,
      this.redis,
    ...
    Log.info(
      this.logger,
      'WorkspaceProjector initialized with production-ready utilities',
      {
        method: 'constructor',
  ...
  onModuleInit(): void {
    Log.info(
      this.logger,
      'Starting Workspace Projector with production-ready features',
      {
        method: 'onModuleInit',
        subscriptionGroup: this.subscriptionGroup,
      },
  ...
  /**
   * Extract workspace parameters with enhanced error context
   *
  ...
  private extractWorkspaceParams(
    ...
    try {
      ...
      // Use existing WorkspaceFieldValidatorUtil for validation
      const workspaceData =
