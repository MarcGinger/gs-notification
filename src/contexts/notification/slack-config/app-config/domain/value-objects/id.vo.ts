 ...
 */
export const AppConfigId = createIntegerVO({
  name: 'Id',
  required: true,

  errors: createIntegerVOErrors(AppConfigErrors.INVALID_ID, 'Id'),
});

/** Public instance type for Id */
export type AppConfigId = IntegerVOInstance;

// Convenience creators
export const createAppConfigId = (v: number) => AppConfigId.create(v);
export const appConfigIdFrom = (v: unknown) => AppConfigId.from(v);
