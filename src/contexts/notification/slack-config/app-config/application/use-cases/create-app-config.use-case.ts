...
import type { AppConfigAggregate } from '../../domain/aggregates';
import { createAppConfigAggregateFromProps } from '../../domain/factories';
import { AppConfigErrors } from '../../domain/errors';
import { CreateAppConfigProps } from '../../domain/props';

// Application layer
import type { CreateAppConfigCommand } from '../commands';
import {
  IAppConfigReader,
  IAppConfigWriter,
...
import { ICreateAppConfigUseCase } from './contracts';
...
@Injectable()
export class CreateAppConfigUseCase implements ICreateAppConfigUseCase {
  ...
  constructor(
    ...
    this.loggingConfig = {
      ...
      component: 'CreateAppConfigUseCase',
      domain: 'slack-config',
  ...
  async execute(params: {
    ...
    const operation = 'create_app_config';
    ...
    const safeLogContext = UseCaseLoggingUtil.createLogContext(
      ...
      {
        appConfigCode: command.props.id,
    ...
    >({
      ...
      component: 'CreateAppConfigUseCase',
      operation: 'create_app_config',
      source: 'slack-config.application.create-app-config',
      command,
      logger: this.logger,
      clock: this.clock,
      ...
      repo: {
        save: async (
          ...
          // TODO: PII protection should be implemented in AppConfigWriter implementation
          // at the persistence boundary, not here in the application layer.
          // The AppConfigWriter adapter should:
      ...
      runDomain: ({ metadata, clock }) => {
        ...
        return createAppConfigAggregateFromProps(
          rawProps,
          enhancedMetadata,
          clock,
        );
