...
/**
 * Enhanced Update AppConfig Command with security context and metadata
 */
export class UpdateAppConfigCommand extends BaseCommand {
  constructor(
    user: IUserToken,
    public readonly id: number,
    public readonly props: UpdateAppConfigProps,
