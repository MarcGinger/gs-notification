...
/**
 * Enhanced Delete AppConfig Command with security context and metadata
 */
export class DeleteAppConfigCommand extends BaseCommand {
  constructor(
    user: IUserToken,
  ...
  static create(
    ...
    return new DeleteAppConfigCommand(user, id, correlationId, securityContext);
  }
}
