...
export class ChannelWriterRepository implements IChannelWriter {
  ...
  async save(
    ...
    try {
      ...
      const projection: ChannelProjection = {
        // ChannelProps fields
        id: channel.entity.id.value,
        name: channel.entity.name.value,
        workspaceId: channel.entity.workspaceId.toArray(),
        ...
        subscribedEvents: channel.entity.subscribedEvents?.value,
      ...
      channelStore.set(actor.tenantId, channel.id.value, projection);
  ...
  async delete(
    ...
    try {
      ...
      if (!channelStore.has(actor.tenantId || 'default-tenant', id.value)) {
        ...
        RepositoryLoggingUtil.logOperationError(
          ...
          operation,
          logContext,
          new Error(`Channel not found: ${id.value}`),
          'MEDIUM',
        );
      ...
      channelStore.delete(actor.tenantId || 'default-tenant', id.value);
