...
/**
 * Enhanced Delete AttributeRuleSet Command with security context and metadata
 */
export class DeleteAttributeRuleSetCommand extends BaseCommand {
  constructor(
    user: IUserToken,
  ...
  static create(
    ...
    return new DeleteAttributeRuleSetCommand(
      user,
      code,
      correlationId,
      securityContext,
