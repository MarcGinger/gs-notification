...
// AttributeRuleSet Projector Module
// Configures AttributeRuleSet Projector with shared projection infrastructure
...
import { AttributeRuleSetProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  providers: [
    // Map attributes domain tokens to infrastructure tokens
    {
      provide: ATTRIBUTES_DI_TOKENS.IO_REDIS, // 'AttributesRedisClient'
      useExisting: IO_REDIS, // 'IORedis'
    },
    {
      provide: ATTRIBUTES_DI_TOKENS.DATA_SOURCE, // 'AttributesDataSource'
      useExisting: DATA_SOURCE, // 'DATA_SOURCE'
    },
    {
      provide: ATTRIBUTES_DI_TOKENS.CHECKPOINT_STORE, // 'AttributesCheckpointStore'
    ...
    {
      provide: ATTRIBUTES_DI_TOKENS.CACHE_SERVICE, // 'AttributesCacheService'
      useExisting: CACHE_SERVICE, // 'CACHE_SERVICE'
    },
    {
      provide: ATTRIBUTES_DI_TOKENS.CATCHUP_RUNNER, // 'AttributesCatchupRunner'
      inject: [
        EventStoreService,
        ATTRIBUTES_DI_TOKENS.CHECKPOINT_STORE,
        APP_LOGGER,
      ],
      useFactory: (
    ...
    AttributeRuleSetProjector,
  ],
  controllers: [AttributeRuleSetProjectorHealthController],
  exports: [AttributeRuleSetProjector],
})
export class AttributeRuleSetProjectorModule {}
