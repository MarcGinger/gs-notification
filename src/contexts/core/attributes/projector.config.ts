...
// Module-specific projector configuration for core
...
/**
 * Configuration service for core projectors
 * Provides module-namespaced Redis key prefixes to prevent collisions
 */
export class CoreProjectorConfig {
  /**
   * Get projector configuration with core namespace
   */
  static getConfig(
    ...
    return ProjectorConfigBuilder.build({
      ...overrides,
      moduleNamespace: AttributesServiceConstants.MODULE_NAMESPACE,
    });
  }
  ...
  static getModuleNamespace(): string {
    return AttributesServiceConstants.MODULE_NAMESPACE;
  }
