...
// AttributeRule Projector Module
// Configures AttributeRule Projector with shared projection infrastructure
...
import { AttributeRuleProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  providers: [
    ...
    AttributeRuleProjector,
  ],
  controllers: [AttributeRuleProjectorHealthController],
  exports: [AttributeRuleProjector],
})
export class AttributeRuleProjectorModule {}
