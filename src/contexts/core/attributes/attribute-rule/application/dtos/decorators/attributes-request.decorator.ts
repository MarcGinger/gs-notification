...
import { UpdateRuleRequest } from '../../dtos/rule';
...
/**
 * Request property decorator for AttributeRule Attributes (object/array)
 * @param {Object} options - Options for the decorator
 * @returns {PropertyDecorator}
 */
export function ApiAttributeRuleAttributesRequest(options: PropOptions = {}) {
  ...
  return applyDecorators(
    ApiProperty({
      ...
      type: 'object',
      additionalProperties: { $ref: getSchemaPath(UpdateRuleRequest) },
      required: [],
    }),
    Transform(({ value }) =>
      transformAndValidateRecord(value, UpdateRuleRequest),
    ),
