...
// LookupType Projector Module
// Configures LookupType Projector with shared projection infrastructure
...
import { LookupTypeProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [LookupTypeProjectorHealthController],
  exports: [LookupTypeProjector],
})
export class LookupTypeProjectorModule {}
