 ...
 */
export const LookupXxxCode = createUuidVO({
  name: 'Code',
  required: true,
  version: 4,
  ...
  errors: createUuidVOErrors(LookupXxxErrors.INVALID_CODE, 'Code'),
});

/** Public instance type for Code */
export type LookupXxxCode = UuidVOInstance;

// Convenience creators
export const createLookupXxxCode = (v: string) => LookupXxxCode.create(v);
export const lookupXxxCodeFrom = (v: unknown) => LookupXxxCode.from(v);
