...
// LookupXxx Projector Module
// Configures LookupXxx Projector with shared projection infrastructure
...
import { LookupXxxProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [LookupXxxProjectorHealthController],
  exports: [LookupXxxProjector],
})
export class LookupXxxProjectorModule {}
