...
/**
 * Enhanced Delete Lookup Command with security context and metadata
 */
export class DeleteLookupCommand extends BaseCommand {
  constructor(
    user: IUserToken,
  ...
  static create(
    ...
    return new DeleteLookupCommand(user, code, correlationId, securityContext);
  }
}
