...
/**
 * Lookup Field Validator Utility
 *
 * Centralized utility for parsing and validating Lookup aggregate data from EventStore events.
 * Provides consistent field validation patterns that can be reused across repositories
 * and projectors for Lookup domain operations.
 *
 * @domain Notification Context - Lookup Field Validation Utility
 * @layer Infrastructure
 * @pattern Utility Pattern + Field Validation
 */
export class LookupFieldValidatorUtil {
  /**
   ...
   */
  static createLookupProjectorDataFromEventData(
