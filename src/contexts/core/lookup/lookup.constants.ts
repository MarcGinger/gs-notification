...
/**
 * Lookup Domain Constants
 *
 * Centralized constants for the lookup bounded context to avoid
...
export const LOOKUP_DI_TOKENS = {
  ...
  IO_REDIS: 'LookupRedisClient', // Token expected by projectors
  CACHE_SERVICE: 'LookupCacheService',
  CHECKPOINT_STORE: 'LookupCheckpointStore',
  DATA_SOURCE: 'LookupDataSource',
  CATCHUP_RUNNER: 'LookupCatchupRunner',
 ...
 */
export const LOOKUP_ERROR_CATEGORIES = {
 ...
 */
export const LOOKUP_DATA_CLASSIFICATION = {
 ...
 */
export const LOOKUP_PERMISSION_TAGS = {
  BULK: 'bulk',
  IMPORT: 'import',
  EXPORT: 'export',
  ADMIN: 'admin',
 ...
 */
export type LookupDIToken =
  (typeof LOOKUP_DI_TOKENS)[keyof typeof LOOKUP_DI_TOKENS];
export type LookupErrorCategory =
  (typeof LOOKUP_ERROR_CATEGORIES)[keyof typeof LOOKUP_ERROR_CATEGORIES];
export type LookupDataClassification =
  (typeof LOOKUP_DATA_CLASSIFICATION)[keyof typeof LOOKUP_DATA_CLASSIFICATION];
export type LookupOperation =
  (typeof LOOKUP_OPERATIONS)[keyof typeof LOOKUP_OPERATIONS];
export type LookupPermissionTag =
  (typeof LOOKUP_PERMISSION_TAGS)[keyof typeof LOOKUP_PERMISSION_TAGS];
