 ...
 */
export const LOOKUP_TYPE_QUERY_TOKEN = 'ILookupTypeQuery' as const;

/**
 * LookupType Query Port - Interface Segregation Principle Implementation
 *
 ...
 *
 * @domain Core Context - LookupType Query Port
 * @layer Application Ports
 * @pattern Interface Segregation Principle
 */
export interface ILookupTypeQuery {
  /**
