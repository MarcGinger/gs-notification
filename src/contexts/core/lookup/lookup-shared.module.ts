...
import { LookupPolicyService } from './lookup-policy.service';
...
/**
 * Lookup Shared Module
 *
 * Provides common infrastructure and services for all lookup domain modules.
 * This module is marked as @Global to avoid re-importing in every domain module.
 *
 * Shared Services:
 * - LookupPolicyService: PII policy registration for the entire domain
 ...
 * - LOOKUP_DI_TOKENS.AUTHORIZATION_SERVICE: Noop/Opa-AuthorizationService for development
 *
 * Shared Infrastructure:
...
@Module({
  ...
  providers: [
    ...
    {
      provide: LOOKUP_DI_TOKENS.IO_REDIS,
      useExisting: IO_REDIS,
    },
    {
      provide: LOOKUP_DI_TOKENS.DATA_SOURCE,
      useExisting: DATA_SOURCE,
    },
    {
      provide: LOOKUP_DI_TOKENS.CACHE_SERVICE,
      useExisting: CACHE_SERVICE,
    },

    // Common infrastructure services
    {
      provide: LOOKUP_DI_TOKENS.AUTHORIZATION_SERVICE,
    ...
    },
    {
      ...
      useFactory: (clock: Clock) =>
        new MetadataFactory(LookupServiceConstants.SERVICE_NAME, clock),
    },
    ...
    // Application-scoped logger using centralized constants
    {
      ...
      useFactory: (loggerFactory: ServiceLoggerFactory) => {
        return loggerFactory.getLogger({
          boundedContext: LookupServiceConstants.BOUNDED_CONTEXT,
  ...
  exports: [
    ...
    LookupPolicyService,
    LOOKUP_DI_TOKENS.AUTHORIZATION_SERVICE,
    LOOKUP_DI_TOKENS.IO_REDIS,
    LOOKUP_DI_TOKENS.DATA_SOURCE,
    LOOKUP_DI_TOKENS.CACHE_SERVICE,
    MetadataFactory,
    RepositoryMetricsService,
    APP_LOGGER,
  ],
})
export class LookupSharedModule {}
