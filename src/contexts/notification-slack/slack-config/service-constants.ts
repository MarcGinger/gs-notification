 ...
 * Bounded Context: notification-slack Module
 */
export class SlackConfigServiceConstants {
  /**
   * Bounded context identifier for domain separation
   */
  static readonly BOUNDED_CONTEXT = 'notification-slack' as const;

  static readonly MODULE_NAMESPACE = 'notification_slack.slack';
