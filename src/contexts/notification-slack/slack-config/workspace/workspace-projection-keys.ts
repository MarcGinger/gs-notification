...
export class WorkspaceProjectionKeys {
  ...
  // The CacheOptimizationUtils class uses notification-slack.slack:pp:ver:{tenant}:workspace:{workspaceId}
   ...
   * Format: notification-slack.slack:v1:{tenantId}:workspace:{workspaceId}
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:idx:workspace:list
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:idx:workspace:by-category:{category}
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:workspace:*
   */
   ...
   * Format: notification-slack.slack:v1:*:workspace:*
   */
   ...
   * Format: notification-slack.slack:pp:ver:{tenantId}:workspace:{workspaceId}
   */
  static getNamespacedVersionHintKey(
    tenantId: string,
    workspaceId: string,
  ): string {
    return `notification-slack.slack:pp:ver:{${tenantId}}:workspace:${workspaceId}`;
  }
  ...
  static getCurrentKeyPatterns(): string[] {
    return [
      'notification-slack.slack:v1:*:workspace:*', // Business data keys
      'notification-slack.slack:pp:ver:*:workspace:*', // Namespaced version hints
