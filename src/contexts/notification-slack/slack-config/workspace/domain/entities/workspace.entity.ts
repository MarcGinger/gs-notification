 ...
 *
 * Represents the core Workspace entity in the notification-slack domain.
 ...
 *
 * @domain NotificationSlack Context - Workspace Entity
 ...
 * Workspace Entity
 *
 * Core domain entity representing a workspace in the notification-slack.
