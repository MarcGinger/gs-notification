...
// Module-specific projector configuration for notification-slack.slack
...
/**
 * Configuration service for notification-slack.slack projectors
 * Provides module-namespaced Redis key prefixes to prevent collisions
 */
export class NotificationSlackSlackProjectorConfig {
  /**
   * Get projector configuration with notification-slack.slack namespace
   */
  static getConfig(
