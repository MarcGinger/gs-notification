...
/**
 * Setup notification-slack-slack-config application/service Swagger documentation
 * Configures documentation for all aggregates within the notification_slack_slack_config domain
 */
export function setupNotificationSlackSlackConfigDocs(
  ...
  // Setup documentation for all notification_slack_slack_config aggregates
