...
// Configures Channel Projector with shared projection infrastructure
...
import { ChannelProjectorHealthController } from './interface/http/controllers';
...
@Module({
  ...
  controllers: [ChannelProjectorHealthController],
  exports: [ChannelProjector],
})
export class ChannelProjectorModule {}
