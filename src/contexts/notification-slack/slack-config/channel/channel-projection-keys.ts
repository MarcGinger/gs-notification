...
export class ChannelProjectionKeys {
  ...
  // The CacheOptimizationUtils class uses notification-slack.slack:pp:ver:{tenant}:channel:{channelId}
   ...
   * Format: notification-slack.slack:v1:{tenantId}:channel:{channelId}
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:idx:channel:list
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:idx:channel:by-category:{category}
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:channel:*
   */
   ...
   * Format: notification-slack.slack:v1:*:channel:*
   */
   ...
   * Format: notification-slack.slack:pp:ver:{tenantId}:channel:{channelId}
   */
  static getNamespacedVersionHintKey(
    tenantId: string,
    channelId: string,
  ): string {
    return `notification-slack.slack:pp:ver:{${tenantId}}:channel:${channelId}`;
  }
  ...
  static getCurrentKeyPatterns(): string[] {
    return [
      'notification-slack.slack:v1:*:channel:*', // Business data keys
      'notification-slack.slack:pp:ver:*:channel:*', // Namespaced version hints
