 ...
 * - Channel Hash: `channel:projection:{tenantId}:id` - stores all channel fields
 * - Tenant Index: `channel:index:by_tenant:{tenantId}` - sorted set by updated timestamp
 *
 * Key Features:
  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  private generateClusterSafeKeys(params: ChannelRowParams): {
    ...
    const entityKey = 'channel:{' + params.tenantId + '}:' + params.id;
    const indexKey = 'channel:index:{' + params.tenantId + '}';
