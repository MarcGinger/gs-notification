 ...
 */
export const APP_CONFIG_QUERY_TOKEN = 'IAppConfigQuery' as const;

/**
 * AppConfig Query Port - Interface Segregation Principle Implementation
 *
 ...
 *
 * @domain NotificationSlack Context - AppConfig Query Port
 * @layer Application Ports
 * @pattern Interface Segregation Principle
 */
export interface IAppConfigQuery {
  /**
