...
export class AppConfigProjectionKeys {
  ...
  // The CacheOptimizationUtils class uses notification-slack.slack:pp:ver:{tenant}:app-config:{appConfigId}
   ...
   * Format: notification-slack.slack:v1:{tenantId}:app-config:{appConfigId}
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:idx:app-config:list
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:idx:app-config:by-category:{category}
   */
   ...
   * Format: notification-slack.slack:v1:{tenantId}:app-config:*
   */
   ...
   * Format: notification-slack.slack:v1:*:app-config:*
   */
   ...
   * Format: notification-slack.slack:pp:ver:{tenantId}:app-config:{appConfigId}
   */
  static getNamespacedVersionHintKey(
    tenantId: string,
    appConfigId: string,
  ): string {
    return `notification-slack.slack:pp:ver:{${tenantId}}:app-config:${appConfigId}`;
  }
  ...
  static getCurrentKeyPatterns(): string[] {
    return [
      'notification-slack.slack:v1:*:app-config:*', // Business data keys
      'notification-slack.slack:pp:ver:*:app-config:*', // Namespaced version hints
