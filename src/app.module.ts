...
const appLoggerFactory = createServiceLoggerFactory('notification.slack');
...
const createDopplerConfig = () => {
  ...
  const config = {
    project: process.env.DOPPLER_PROJECT || 'notification-slack-api',
...
@Module({
  ...
  controllers: [],
  providers: [
    // Main app logger with 'notification-slack' service name
