...
const createDopplerConfig = () => {
  ...
  const config = {
    project: process.env.DOPPLER_PROJECT || 'notification-slack-execute-api',
...
@Module({
  ...
  controllers: [],
  providers: [
    // Main app logger with 'notification-slack-execute' service name
