...
export class OpaGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!resourceOptions) {
      Log.debug(this.logger, 'opa.guard.no_resource_metadata', {
        method: 'canActivate',
      });
      return true;
    }
    ...
    try {
      ...
      if (!decision.allow) {
        Log.warn(this.logger, 'opa.guard.access_denied', {
          method: 'canActivate',
          ...authContext,
      ...
      Log.debug(this.logger, 'opa.guard.access_granted', {
        method: 'canActivate',
        ...authContext,
      ...
      Log.error(this.logger, 'opa.guard.authorization_error', {
        method: 'canActivate',
        ...authContext,
