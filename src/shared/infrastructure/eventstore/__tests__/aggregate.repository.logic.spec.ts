/* eslint-disable @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access -- Reason: Test file needs flexible typing and legacy patterns. Ticket: TICKET-REQUIRED */
