/*
 eslint-disable @typescript-eslint/no-unsafe-assignment,
   ...
   -- Reason: test file uses many mocked `any` values and async generator stubs that are intentionally untyped; these are test-only patterns and changing them is high-risk. Ticket: TICKET-REQUIRED
*/
