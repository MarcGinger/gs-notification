...
export const AppDataSource = new DataSource({
  ...
  // Schema configuration - each bounded context gets its own schema for DDD isolation
  // This ensures proper domain boundaries and prevents cross-context coupling
  ...
  entities: [
    ...
    __dirname +
      '/../../../catalog/product/infrastructure/typeorm/entities/*.entity.{ts,js}',
  ],
