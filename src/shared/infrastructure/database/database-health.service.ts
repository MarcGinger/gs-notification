...
export class DatabaseHealthService {
  ...
  async isHealthy(): Promise<boolean> {
    try {
      ...
      Log.error(this.logger, 'Database health check failed', {
  ...
  async getHealthDetails(): Promise<{
    ...
    try {
      ...
      const e = error as Error;
      Log.error(this.logger, 'Database health details check failed', {
        component: 'DatabaseHealthService',
  ...
  async getMigrationStatus(): Promise<{
    ...
    try {
      ...
      const e = error as Error;
      Log.error(this.logger, 'Migration status check failed', {
        component: 'DatabaseHealthService',
