/* eslint-disable @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-require-imports -- Reason: Test file needs flexible typing and legacy patterns. Ticket: TICKET-REQUIRED */
